...
public class WiimoteDemo : MonoBehaviour {
    ...
    void Update () {
        ...
        do
        {
            ...
            if (ret > 0 && wiimote.current_ext == ExtensionController.MOTIONPLUS && Mathf.Abs(wiimote.MotionPlus.PitchSpeed) > 0.04) {
                Vector3 offset = new Vector3(  -wiimote.MotionPlus.PitchSpeed*50,
                                                0,
